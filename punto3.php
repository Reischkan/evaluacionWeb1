   ...
   <div class="container">
       <div class="row justify-content-center">
           ...
           <form action="punto3.php" method="POST">
                <div class="row mt-5">
                    <div class="col">
                        <input type="text" class="form-control" placeholder="Pares" name="pares">
                    </div>
                    <div class="col">
            ...
            <?php 
                ...
                if(isset($_POST["botonEnviar"])){
                    ...
                    if($pares == 3){
                        ...
                        echo("Precio con descuento del 10%  ".$total-$porcentaje);
                    }
                    elseif($pares>3 && $pares<=8){
                        $porcentaje= $total*0.2;

                        echo("Precio con descuento del 20%  ".$total-$porcentaje);
                    }
                    elseif($pares<8){
                        $porcentaje= $total*0.5;

                        echo("Precio con 50% de descuento   ".$total-$porcentaje);
                    }
